...
import type { DataType, HomePageResponseModel, TimeInterval } from '../models'
import {
  DataTypeFromJSON,
  DataTypeToJSON,
...
export class PageModelApi extends runtime.BaseAPI {
  /**
   */
  async apiV2PagesHomeGetRaw(
    requestParameters: ApiV2PagesHomeGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<HomePageResponseModel>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      HomePageResponseModelFromJSON(jsonValue)
    )
  }

  /**
   */
  async apiV2PagesHomeGet(
    requestParameters: ApiV2PagesHomeGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<HomePageResponseModel> {
    const response = await this.apiV2PagesHomeGetRaw(
      requestParameters,
      initOverrides
    )
  ...
  /**
   */
  async apiV2PagesProviderGetRaw(
    requestParameters: ApiV2PagesProviderGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
