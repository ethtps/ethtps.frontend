...
export function APIKeyResponseModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    requestLimit24h: !exists(json, 'requestLimit24h')
      ? undefined
      : json['requestLimit24h']
  }
}

export function APIKeyResponseModelToJSON(
  value?: APIKeyResponseModel | null
): any {
  if (value === undefined) {
    return undefined
  }
