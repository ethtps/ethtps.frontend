...
export function ComplexDatasetAnalysisFromJSON(
  json: any
): ComplexDatasetAnalysis {
  return ComplexDatasetAnalysisFromJSONTyped(json, false)
}

export function ComplexDatasetAnalysisFromJSONTyped(
  json: any,
  ...
  return {
    max: !exists(json, 'max')
      ? undefined
      : IXYMultiConvertibleFromJSON(json['max']),
    min: !exists(json, 'min')
      ? undefined
      : IXYMultiConvertibleFromJSON(json['min']),
    mean: !exists(json, 'mean') ? undefined : json['mean']
  }
}

export function ComplexDatasetAnalysisToJSON(
  value?: ComplexDatasetAnalysis | null
): any {
  if (value === undefined) {
    return undefined
  }
