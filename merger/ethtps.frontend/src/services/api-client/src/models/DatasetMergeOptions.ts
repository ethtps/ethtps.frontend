...
export function DatasetMergeOptionsFromJSONTyped(
  json: any,
  ...
  return {
    mergePercentage: !exists(json, 'mergePercentage')
      ? undefined
      : json['mergePercentage'],
    maxCount: !exists(json, 'maxCount') ? undefined : json['maxCount']
  }
}

export function DatasetMergeOptionsToJSON(
  value?: DatasetMergeOptions | null
): any {
  if (value === undefined) {
    return undefined
  }
