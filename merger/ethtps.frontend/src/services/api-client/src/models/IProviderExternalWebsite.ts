...
export function IProviderExternalWebsiteFromJSON(
  json: any
): IProviderExternalWebsite {
  return IProviderExternalWebsiteFromJSONTyped(json, false)
}

export function IProviderExternalWebsiteFromJSONTyped(
  json: any,
...
export function IProviderExternalWebsiteToJSON(
  value?: IProviderExternalWebsite | null
): any {
  if (value === undefined) {
    return undefined
  }
