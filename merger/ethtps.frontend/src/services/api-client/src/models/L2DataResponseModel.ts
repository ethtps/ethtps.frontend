...
import { DatasetFromJSON, DatasetFromJSONTyped, DatasetToJSON } from './Dataset'
...
export function L2DataResponseModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    datasets: !exists(json, 'datasets')
      ...
      : json['datasets'] === null
      ? null
      : (json['datasets'] as Array<any>).map(DatasetFromJSON),
...
export function L2DataResponseModelToJSON(
  value?: L2DataResponseModel | null
): any {
  if (value === undefined) {
    return undefined
  }
  ...
  return {
    ...
    datasets:
      value.datasets === undefined
        ...
        : value.datasets === null
        ? null
        : (value.datasets as Array<any>).map(DatasetToJSON),
