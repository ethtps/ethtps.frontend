...
export function NetworkFromJSONTyped(
  ...
  return {
    ...
    starkwareTransactionCountData: !exists(
      json,
      'starkwareTransactionCountData'
    )
      ? undefined
      : json['starkwareTransactionCountData'] === null
      ? null
      : (json['starkwareTransactionCountData'] as Array<any>).map(
          StarkwareTransactionCountDatumFromJSON
        ),
    ...
    tpsandGasDataLatests: !exists(json, 'tpsandGasDataLatests')
      ? undefined
      : json['tpsandGasDataLatests'] === null
      ? null
      : (json['tpsandGasDataLatests'] as Array<any>).map(
          TpsandGasDataLatestFromJSON
        ),
    tpsandGasDataMaxes: !exists(json, 'tpsandGasDataMaxes')
      ? undefined
      : json['tpsandGasDataMaxes'] === null
      ? null
      : (json['tpsandGasDataMaxes'] as Array<any>).map(
          TpsandGasDataMaxFromJSON
        ),
