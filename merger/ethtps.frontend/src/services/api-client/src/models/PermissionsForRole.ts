...
export function PermissionsForRoleFromJSONTyped(
  json: any,
  ...
  return {
    ...
    permission: !exists(json, 'permission')
      ? undefined
      : PermissionFromJSON(json['permission']),
    role: !exists(json, 'role') ? undefined : RoleFromJSON(json['role'])
  }
}

export function PermissionsForRoleToJSON(
  value?: PermissionsForRole | null
): any {
  if (value === undefined) {
    return undefined
  }
