...
import { IBlockFromJSON, IBlockToJSON } from '../models'
...
export class BlockInfoApi extends runtime.BaseAPI {
  /**
   */
  async apiV3BlockInfoGetBlocksBetweenGetRaw(
    requestParameters: ApiV3BlockInfoGetBlocksBetweenGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<IBlock>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(IBlockFromJSON)
    )
  }

  /**
   */
  async apiV3BlockInfoGetBlocksBetweenGet(
    requestParameters: ApiV3BlockInfoGetBlocksBetweenGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<IBlock>> {
    const response = await this.apiV3BlockInfoGetBlocksBetweenGetRaw(
      requestParameters,
      initOverrides
    )
  ...
  /**
   */
  async apiV3BlockInfoGetLatestBlocksGetRaw(
    requestParameters: ApiV3BlockInfoGetLatestBlocksGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<IBlock>>> {
    const queryParameters: any = {}
  ...
  /**
   */
  async apiV3BlockInfoGetLatestBlocksGet(
    requestParameters: ApiV3BlockInfoGetLatestBlocksGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<IBlock>> {
    const response = await this.apiV3BlockInfoGetLatestBlocksGetRaw(
      requestParameters,
      initOverrides
    )
    return await response.value()
