...
export class ChartDataApi extends runtime.BaseAPI {
  /**
   */
  async apiV3ChartDataGetStackedChartDataGetRaw(
    requestParameters: ApiV3ChartDataGetStackedChartDataGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StackedChartModel>> {
    ...
    if (
      requestParameters.combineSeriesWithAverageLessThanPercentage !== undefined
    ) {
      queryParameters['CombineSeriesWithAverageLessThanPercentage'] =
        requestParameters.combineSeriesWithAverageLessThanPercentage
    }

    if (requestParameters.orderByDateAscending !== undefined) {
      queryParameters['OrderByDateAscending'] =
        requestParameters.orderByDateAscending
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StackedChartModelFromJSON(jsonValue)
    )
  }

  /**
   */
  async apiV3ChartDataGetStackedChartDataGet(
    requestParameters: ApiV3ChartDataGetStackedChartDataGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StackedChartModel> {
    const response = await this.apiV3ChartDataGetStackedChartDataGetRaw(
      requestParameters,
      initOverrides
    )
  ...
  /**
   */
  async apiV3ChartDataGetStreamchartDataGetRaw(
    requestParameters: ApiV3ChartDataGetStreamchartDataGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StreamchartModel>> {
    const queryParameters: any = {}
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StreamchartModelFromJSON(jsonValue)
    )
  }

  /**
   */
  async apiV3ChartDataGetStreamchartDataGet(
    requestParameters: ApiV3ChartDataGetStreamchartDataGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StreamchartModel> {
    const response = await this.apiV3ChartDataGetStreamchartDataGetRaw(
      requestParameters,
      initOverrides
    )
    return await response.value()
