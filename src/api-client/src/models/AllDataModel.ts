...
export function AllDataModelFromJSONTyped(
  json: any,
  ...
  return {
    providers: !exists(json, 'providers')
      ...
      : json['providers'] === null
      ? null
      : (json['providers'] as Array<any>).map(ProviderModelFromJSON),
    maxData: !exists(json, 'maxData') ? undefined : json['maxData'],
    allTPSData: !exists(json, 'allTPSData')
      ? undefined
      : AllDataModelAllTPSDataFromJSON(json['allTPSData']),
    allGPSData: !exists(json, 'allGPSData')
      ? undefined
      : AllDataModelAllTPSDataFromJSON(json['allGPSData']),
    allGasAdjustedTPSData: !exists(json, 'allGasAdjustedTPSData')
      ? undefined
      : AllDataModelAllTPSDataFromJSON(json['allGasAdjustedTPSData'])
  }
}
  ...
  return {
    providers:
      value.providers === undefined
        ...
        ? null
        : (value.providers as Array<any>).map(ProviderModelToJSON),
    ...
    allGasAdjustedTPSData: AllDataModelAllTPSDataToJSON(
      value.allGasAdjustedTPSData
    )
  }
}
