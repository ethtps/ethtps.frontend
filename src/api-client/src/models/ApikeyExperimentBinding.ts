...
export function ApikeyExperimentBindingFromJSON(
  json: any
): ApikeyExperimentBinding {
  return ApikeyExperimentBindingFromJSONTyped(json, false)
}

export function ApikeyExperimentBindingFromJSONTyped(
  json: any,
  ...
  return {
    ...
    apikey: !exists(json, 'apikey')
      ? undefined
      : ApikeyFromJSON(json['apikey']),
    experiment: !exists(json, 'experiment')
      ? undefined
      : ExperimentFromJSON(json['experiment'])
  }
}

export function ApikeyExperimentBindingToJSON(
  value?: ApikeyExperimentBinding | null
): any {
  if (value === undefined) {
    return undefined
  }
