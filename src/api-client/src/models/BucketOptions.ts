...
export function BucketOptionsFromJSONTyped(
  json: any,
  ...
  return {
    useTimeBuckets: !exists(json, 'useTimeBuckets')
      ? undefined
      : json['useTimeBuckets'],
    bucketSize: !exists(json, 'bucketSize')
      ? undefined
      : TimeIntervalFromJSON(json['bucketSize']),
    customBucketSize: !exists(json, 'customBucketSize')
      ? undefined
      : json['customBucketSize']
  }
}
