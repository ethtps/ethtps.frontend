...
export function ExperimentFromJSONTyped(
  ...
  return {
    ...
    runParameters: !exists(json, 'runParameters')
      ? undefined
      : json['runParameters'],
    apikeyExperimentBindings: !exists(json, 'apikeyExperimentBindings')
      ? undefined
      : json['apikeyExperimentBindings'] === null
      ? null
      : (json['apikeyExperimentBindings'] as Array<any>).map(
          ApikeyExperimentBindingFromJSON
        ),
    experimentFeedbacks: !exists(json, 'experimentFeedbacks')
      ? undefined
      : json['experimentFeedbacks'] === null
      ? null
      : (json['experimentFeedbacks'] as Array<any>).map(
          ExperimentFeedbackFromJSON
        ),
    experimentResults: !exists(json, 'experimentResults')
      ? undefined
      : json['experimentResults'] === null
      ? null
      : (json['experimentResults'] as Array<any>).map(ExperimentResultFromJSON),
    experimentalSession: !exists(json, 'experimentalSession')
      ? undefined
      : ExperimentalSessionFromJSON(json['experimentalSession']),
    project: !exists(json, 'project')
      ? undefined
      : ProviderFromJSON(json['project']),
    runParametersNavigation: !exists(json, 'runParametersNavigation')
      ? undefined
      : ExperimentRunParameterFromJSON(json['runParametersNavigation']),
    targetNavigation: !exists(json, 'targetNavigation')
      ? undefined
      : ExperimentTargetFromJSON(json['targetNavigation'])
  }
}
...
export function ExperimentToJSON(value?: Experiment | null): any {
  ...
  return {
    ...
    runParametersNavigation: ExperimentRunParameterToJSON(
      value.runParametersNavigation
    ),
