...
export function ExperimentRunParameterFromJSON(
  json: any
): ExperimentRunParameter {
  return ExperimentRunParameterFromJSONTyped(json, false)
}

export function ExperimentRunParameterFromJSONTyped(
  json: any,
  ...
  return {
    ...
    displayToNpeopleBeforeEnd: !exists(json, 'displayToNpeopleBeforeEnd')
      ? undefined
      : json['displayToNpeopleBeforeEnd'],
    considerFinishedAfterTimeoutSeconds: !exists(
      json,
      'considerFinishedAfterTimeoutSeconds'
    )
      ? undefined
      : json['considerFinishedAfterTimeoutSeconds'],
    enrollmentChance: !exists(json, 'enrollmentChance')
      ? undefined
      : json['enrollmentChance'],
...
export function ExperimentRunParameterToJSON(
  value?: ExperimentRunParameter | null
): any {
  if (value === undefined) {
    return undefined
  }
  ...
  return {
    ...
    considerFinishedAfterTimeoutSeconds:
      value.considerFinishedAfterTimeoutSeconds,
