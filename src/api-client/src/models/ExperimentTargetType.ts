...
export function ExperimentTargetTypeFromJSONTyped(
  json: any,
  ...
  return {
    ...
    targetTypeName: !exists(json, 'targetTypeName')
      ? undefined
      : json['targetTypeName'],
    targetTypeValue: !exists(json, 'targetTypeValue')
      ? undefined
      : json['targetTypeValue'],
    experimentTargets: !exists(json, 'experimentTargets')
      ? undefined
      : json['experimentTargets'] === null
      ? null
      : (json['experimentTargets'] as Array<any>).map(ExperimentTargetFromJSON)
  }
}

export function ExperimentTargetTypeToJSON(
  value?: ExperimentTargetType | null
): any {
  if (value === undefined) {
    return undefined
  }
