...
export function IBasicLiveUpdaterStatusFromJSON(
  json: any
): IBasicLiveUpdaterStatus {
  return IBasicLiveUpdaterStatusFromJSONTyped(json, false)
}

export function IBasicLiveUpdaterStatusFromJSONTyped(
  json: any,
...
export function IBasicLiveUpdaterStatusToJSON(
  value?: IBasicLiveUpdaterStatus | null
): any {
  if (value === undefined) {
    return undefined
  }
