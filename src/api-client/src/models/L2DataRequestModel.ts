...
export function L2DataRequestModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    returnXAxisType: !exists(json, 'returnXAxisType')
      ? undefined
      : XPointTypeFromJSON(json['returnXAxisType']),
    includeEmptyDatasets: !exists(json, 'includeEmptyDatasets')
      ? undefined
      : json['includeEmptyDatasets'],
    mergeOptions: !exists(json, 'mergeOptions')
      ? undefined
      : DatasetMergeOptionsFromJSON(json['mergeOptions']),
    includeSimpleAnalysis: !exists(json, 'includeSimpleAnalysis')
      ? undefined
      : json['includeSimpleAnalysis'],
    includeComplexAnalysis: !exists(json, 'includeComplexAnalysis')
      ? undefined
      : json['includeComplexAnalysis'],
    providers: !exists(json, 'providers') ? undefined : json['providers'],
    provider: !exists(json, 'provider') ? undefined : json['provider'],
    network: !exists(json, 'network') ? undefined : json['network'],
    includeSidechains: !exists(json, 'includeSidechains')
      ? undefined
      : json['includeSidechains']
  }
}

export function L2DataRequestModelToJSON(
  value?: L2DataRequestModel | null
): any {
  if (value === undefined) {
    return undefined
  }
