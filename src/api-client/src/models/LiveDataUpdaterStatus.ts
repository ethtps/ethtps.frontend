...
export function LiveDataUpdaterStatusFromJSON(
  json: any
): LiveDataUpdaterStatus {
  return LiveDataUpdaterStatusFromJSONTyped(json, false)
}

export function LiveDataUpdaterStatusFromJSONTyped(
  json: any,
  ...
  return {
    ...
    lastSuccessfulRunTime: !exists(json, 'lastSuccessfulRunTime')
      ? undefined
      : json['lastSuccessfulRunTime'] === null
      ? null
      : new Date(json['lastSuccessfulRunTime']),
    lastRunTime: !exists(json, 'lastRunTime')
      ? undefined
      : json['lastRunTime'] === null
      ? null
      : new Date(json['lastRunTime']),
    numberOfSuccesses: !exists(json, 'numberOfSuccesses')
      ? undefined
      : json['numberOfSuccesses'],
    numberOfFailures: !exists(json, 'numberOfFailures')
      ? undefined
      : json['numberOfFailures'],
    status: !exists(json, 'status')
      ? undefined
      : DataUpdaterStatusFromJSON(json['status']),
    updater: !exists(json, 'updater')
      ? undefined
      : DataUpdaterFromJSON(json['updater'])
  }
}

export function LiveDataUpdaterStatusToJSON(
  value?: LiveDataUpdaterStatus | null
): any {
  if (value === undefined) {
    return undefined
  }
  ...
  return {
    ...
    lastSuccessfulRunTime:
      value.lastSuccessfulRunTime === undefined
        ? undefined
        : value.lastSuccessfulRunTime === null
        ? null
        : value.lastSuccessfulRunTime.toISOString(),
    lastRunTime:
      value.lastRunTime === undefined
        ? undefined
        : value.lastRunTime === null
        ? null
        : value.lastRunTime.toISOString(),
