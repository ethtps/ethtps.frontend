...
export function OldestLoggedTimeWarpBlockFromJSON(
  json: any
): OldestLoggedTimeWarpBlock {
  return OldestLoggedTimeWarpBlockFromJSONTyped(json, false)
}

export function OldestLoggedTimeWarpBlockFromJSONTyped(
  json: any,
...
export function OldestLoggedTimeWarpBlockToJSON(
  value?: OldestLoggedTimeWarpBlock | null
): any {
  if (value === undefined) {
    return undefined
  }
