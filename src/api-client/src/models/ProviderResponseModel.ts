...
export function ProviderResponseModelFromJSON(
  json: any
): ProviderResponseModel {
  return ProviderResponseModelFromJSONTyped(json, false)
}

export function ProviderResponseModelFromJSONTyped(
  json: any,
  ...
  return {
    ...
    isSubchainOf: !exists(json, 'isSubchainOf')
      ? undefined
      : json['isSubchainOf'],
    status: !exists(json, 'status')
      ? undefined
      : IBasicLiveUpdaterStatusFromJSON(json['status'])
  }
}

export function ProviderResponseModelToJSON(
  value?: ProviderResponseModel | null
): any {
  if (value === undefined) {
    return undefined
  }
