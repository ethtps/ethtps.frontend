...
export function StackedChartModelFromJSONTyped(
  json: any,
  ...
  return {
    series: !exists(json, 'series')
      ...
      : json['series'] === null
      ? null
      : (json['series'] as Array<any>).map(StackedChartSeriesFromJSON),
  ...
  return {
    series:
      value.series === undefined
        ...
        : value.series === null
        ? null
        : (value.series as Array<any>).map(StackedChartSeriesToJSON)
  }
}
