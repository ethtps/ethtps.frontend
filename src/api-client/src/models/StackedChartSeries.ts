...
export function StackedChartSeriesFromJSONTyped(
  json: any,
  ...
  return {
    dataPoints: !exists(json, 'dataPoints')
      ...
      ? null
      : (json['dataPoints'] as Array<any>).map(StackedChartDataPointFromJSON),
    maxValue: !exists(json, 'maxValue') ? undefined : json['maxValue'],
    provider: !exists(json, 'provider') ? undefined : json['provider']
  }
}

export function StackedChartSeriesToJSON(
  value?: StackedChartSeries | null
): any {
  if (value === undefined) {
    return undefined
  }
  ...
  return {
    dataPoints:
      value.dataPoints === undefined
        ...
        ? null
        : (value.dataPoints as Array<any>).map(StackedChartDataPointToJSON),
