 ...
 */
export function instanceOfStarkwareTransactionCountDatum(
  value: object
): boolean {
  let isInstance = true
...
export function StarkwareTransactionCountDatumFromJSON(
  json: any
): StarkwareTransactionCountDatum {
  return StarkwareTransactionCountDatumFromJSONTyped(json, false)
}

export function StarkwareTransactionCountDatumFromJSONTyped(
  json: any,
  ...
  return {
    ...
    lastUpdateTime: !exists(json, 'lastUpdateTime')
      ? undefined
      : new Date(json['lastUpdateTime']),
    lastUpdateCount: !exists(json, 'lastUpdateCount')
      ? undefined
      : json['lastUpdateCount'],
    lastUpdateTps: !exists(json, 'lastUpdateTps')
      ? undefined
      : json['lastUpdateTps'],
...
export function StarkwareTransactionCountDatumToJSON(
  value?: StarkwareTransactionCountDatum | null
): any {
  if (value === undefined) {
    return undefined
  }
  ...
  return {
    ...
    lastUpdateTime:
      value.lastUpdateTime === undefined
        ? undefined
        : value.lastUpdateTime.toISOString(),
