 ...
 *
 * @export
 * @interface TimeWarpDataWeek
 */
export interface TimeWarpDataWeek {
  /**
   *
   * @type {number}
   * @memberof TimeWarpDataWeek
   */
  id?: number
  /**
   *
...
/**
 * Check if a given object implements the TimeWarpDataWeek interface.
 */
export function instanceOfTimeWarpDataWeek(value: object): boolean {
  let isInstance = true

  return isInstance
}

export function TimeWarpDataWeekFromJSON(json: any): TimeWarpDataWeek {
  return TimeWarpDataWeekFromJSONTyped(json, false)
}

export function TimeWarpDataWeekFromJSONTyped(
  json: any,
...
export function TimeWarpDataWeekToJSON(value?: TimeWarpDataWeek | null): any {
  if (value === undefined) {
    return undefined
  }
  if (value === null) {
