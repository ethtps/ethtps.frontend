...
export function TimeWarpSyncProgressModelFromJSON(
  json: any
): TimeWarpSyncProgressModel {
  return TimeWarpSyncProgressModelFromJSONTyped(json, false)
}

export function TimeWarpSyncProgressModelFromJSONTyped(
  json: any,
  ...
  return {
    currentBlock: !exists(json, 'currentBlock')
      ? undefined
      : json['currentBlock'],
    latestBlockHeight: !exists(json, 'latestBlockHeight')
      ? undefined
      : json['latestBlockHeight']
  }
}

export function TimeWarpSyncProgressModelToJSON(
  value?: TimeWarpSyncProgressModel | null
): any {
  if (value === undefined) {
    return undefined
  }
