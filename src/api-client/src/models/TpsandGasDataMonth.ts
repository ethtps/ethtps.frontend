 ...
 *
 * @export
 * @interface TpsandGasDataMonth
 */
export interface TpsandGasDataMonth {
  /**
   *
   * @type {Date}
   * @memberof TpsandGasDataMonth
   */
  startDate?: Date
  /**
   *
...
/**
 * Check if a given object implements the TpsandGasDataMonth interface.
 */
export function instanceOfTpsandGasDataMonth(value: object): boolean {
  let isInstance = true

  return isInstance
}

export function TpsandGasDataMonthFromJSON(json: any): TpsandGasDataMonth {
  return TpsandGasDataMonthFromJSONTyped(json, false)
}

export function TpsandGasDataMonthFromJSONTyped(
  json: any,
  ...
  return {
    ...
    readingsCount: !exists(json, 'readingsCount')
      ? undefined
      : json['readingsCount'],
...
export function TpsandGasDataMonthToJSON(
  value?: TpsandGasDataMonth | null
): any {
  if (value === undefined) {
    return undefined
  }
