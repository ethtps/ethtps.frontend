...
import { Action, AnyAction, Dispatch, PayloadAction, ThunkAction, ThunkDispatch, configureStore } from '@reduxjs/toolkit';
import { ApplicationState, IApplicationState } from './models';
import { providersReducer, networksReducer, intervalsReducer, dataReducer, liveDataReducer, colorReducer, experimentReducer, applicationStateReducer } from './slices';
