		...
		<Flex
			...
			<Box>
				<SimpleStat
					...
					onMouseOver={() =>
						onMouseOver?.(ETHTPSDataCoreDataType.GPS)
					}
					onMouseLeave={() =>
						onMouseLeave?.(ETHTPSDataCoreDataType.GPS)
					}
					loading={!connected}
					data={data.gps}
					alt={'Gas per second'}
			...
			<Box>
				<SimpleStat
					...
					onMouseOver={() =>
						onMouseOver?.(ETHTPSDataCoreDataType.TPS)
					}
					onMouseLeave={() =>
						onMouseLeave?.(ETHTPSDataCoreDataType.TPS)
					}
					loading={!connected}
					data={data.tps}
			...
			<Box>
				<SimpleStat
					...
					onClick={() =>
						onClick?.(ETHTPSDataCoreDataType.GAS_ADJUSTED_TPS)
					}
					onMouseOver={() =>
						onMouseOver?.(ETHTPSDataCoreDataType.GAS_ADJUSTED_TPS)
					}
					onMouseLeave={() =>
						onMouseLeave?.(ETHTPSDataCoreDataType.GAS_ADJUSTED_TPS)
					}
					loading={!connected}
					data={data.gtps}
