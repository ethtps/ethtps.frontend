import { APIKeyApi, ApiV3ChartDataGetStackedChartDataGetRequest, ApiV3ChartDataGetStreamchartDataGetRequest, ApiV3L2DataGetPostRequest, ChartDataApi, Configuration, ETHTPSDataCoreDataType, ETHTPSDataCoreTimeInterval, ExperimentApi, ExternalWebsiteCategoriesApi, ExternalWebsitesApi, GPSApi, GasAdjustedTPSApi, GeneralApi, L2DataApi, ProviderLinksApi, TPSApi } from 'ethtps.api'
import { DataPointDictionary, DataResponseModelDictionary, StringDictionary } from '../common-types'
...
export class ETHTPSApi {
  ...
  public externalWebsiteCategoriesAPI: ExternalWebsiteCategoriesApi = new ExternalWebsiteCategoriesApi()
  ...
  public resetConfig() {
    ...
    this.externalWebsiteCategoriesAPI = new ExternalWebsiteCategoriesApi(this._genConfig(this._apiURL))
    this.providerLinksAPI = new ProviderLinksApi(this._genConfig(this._apiURL))
    /*
  ...
  public async getJunkL2Data(dataType: ETHTPSDataCoreDataType,
    interval: ETHTPSDataCoreTimeInterval,
    provider?: string,
    network?: string,
    includeSidechains?: boolean) {
