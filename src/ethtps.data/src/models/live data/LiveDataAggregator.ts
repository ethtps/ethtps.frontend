...
export class LiveDataAggregator {
    ...
    public updateMultiple(entries: Dictionary<L2DataUpdateModel>, excludeSidechains?: boolean, providerData?: ETHTPSDataCoreModelsResponseModelsProviderResponseModel[]) {
